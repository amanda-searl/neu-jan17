...
public class Person {
	public void getGroceriesTraditionalWay() {
		...
		System.out.println("Take the Wallet");
		System.out.println("Put the Jacket");
		System.out.println("Check the car air pressure");
		System.out.println("Get into car");
		System.out.println("Drive the car");
		System.out.println("Go to the Grocery Store");
		System.out.println("Shop for Groceries");
		System.out.println("Pay for Groceries");
		System.out.println("Get into car");
